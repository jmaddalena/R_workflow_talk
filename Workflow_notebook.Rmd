...
```{r}
head(barplot_data_list$long_data)
```
...
Another example of ggplot vs base R:
...
```{r}
iris$color <- ifelse(iris$Species=="setosa", "coral", 
                     ifelse(iris$Species=="versicolor", "green",
                            "blue"))
plot(iris$Sepal.Length, iris$Sepal.Width, col = iris$color)
legend("topright",legend = c("setosa", "versicolor", "virginica"),
        col = c("coral", "green", "blue"), pch = 21)
...
# Find all files on GitHub 

https://github.com/jmaddalena/R_workflow_talk
